...
public class vreserva {
 ...
 private vhabitacion habitacion;
    public vreserva() {
    }

    public vreserva(int idreserva, int idhabitacion, int idcliente, int idtrabajador, String tipo_reserva, Date fecha_reserva, Date fecha_ingresa, Date fecha_salida, Double costo_alojamiento, String estado, vhabitacion habitacion) {
